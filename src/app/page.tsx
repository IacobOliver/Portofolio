            ...
            <ModalContent>
              <div className="  ">
                ...
                <div className="flex justify-center items-center gap-5">
                  <a href="\files\OliverResume.pdf" download className="group flex flex-col items-center justify-center w-full h-[280px] border border-[#171717] rounded-lg hover:bg-[#171717] hover:shadow-lg hover:shadow-[#171717]   hover:scale-105 transition-transform duration-300">
                    {/* <Image width={80} height={80} alt="pfpExtended" className="fill-[#171717]" src="/downloadIcon.svg" draggable={false} /> */}
                    <svg width="90px" height="90px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="group overflow-visible mb-3">
                      <defs>
                  ...
                  <a
                    ...
                    className="group flex flex-col items-center justify-center w-full h-[280px] border border-[#171717] rounded-lg hover:bg-[#171717] hover:shadow-lg hover:shadow-[#171717]   hover:scale-105 transition-transform duration-300">
                    <Image width={80} height={80} alt="pfpExtended" className="mb-3 group-hover:scale-125 group-hover:mb-5 transition-transform duration-300" src="/images/icons/docsIcon.png" draggable={false} />
                    <p>Read Online</p>
                  </a>
